 ...
 */
    ...
    //|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-------------|
           KC_NO   ,RGB_TOG ,   KC_7 ,   KC_8 ,   KC_9 ,  KC_NO , KC_DEL , KC_HOME,  KC_UP , KC_END ,  KC_NO ,  KC_UP ,  KC_NO ,    KC_DEL   ,
    //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-------------|
    //|--------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------|
           KC_CAPS   ,  KC_NO ,   KC_4 ,   KC_5 ,   KC_6 ,  KC_NO , KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_LEFT, KC_RGHT,       DF(LED)      ,
    //|--------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------|
    //|------------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----------------+--------|
