 ...
 */
    ...
    //|------------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----------------+--------|
    //|----------+----------+----------+------------------------+----------+--------------------+--------+--------+--------+--------+--------|
         KC_LCTL ,  KC_LGUI ,  KC_LALT ,         KC_SPC         ,  MO(_FN) ,         KC_F19     ,  KC_NO ,  KC_NO ,  KC_NO ,DF(_MAC),   KC_NO
    //|----------+----------+----------+------------------------+----------+--------------------+--------+--------+--------+--------+--------|
    ),
 ...
 */
    ...
    //|------------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----------------+--------|
    //|----------+----------+----------+------------------------+----------+--------------------+--------+--------+--------+--------+--------|
         _______ ,  _______ ,  _______ ,         KC_NO          ,  _______ ,        KC_NO       , OVR_TGL,  KC_NO , BL_TOGG, BL_DEC , BL_STEP
    //|----------+----------+----------+------------------------+----------+--------------------+--------+--------+--------+--------+--------|
    ),
 ...
 */
    ...
    //|------------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----------------+--------|
    //|----------+----------+----------+------------------------+----------+--------------------+--------+--------+--------+--------+--------|
         KC_LCTL ,  KC_LALT ,  KC_LGUI ,    LT(MAC_FN,KC_SPC)   ,MO(MAC_FN),     LGUI(KC_SPC)   ,  KC_NO ,  KC_NO ,  KC_NO ,DF(_QWERTY), KC_NO
    //|----------+----------+----------+------------------------+----------+--------------------+--------+--------+--------+--------+--------|
    ),
    ...
    //|------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-------------|
    //|--------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------|
           KC_CAPS   ,  KC_NO ,   KC_4 ,   KC_5 ,   KC_6 ,  KC_NO , KC_BSPC, KC_LEFT, KC_DOWN,  KC_RGHT , KC_LEFT, KC_RGHT,       KC_PSCR      ,
    //|--------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------|
    //|------------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----------------+--------|
              _______    , RGB_M_P,   KC_1 ,   KC_2 ,   KC_3 ,RGB_M_SN, RGB_M_K,  KC_NO , RGB_M_G,  KC_NO , KC_DOWN, KC_NO , BL_INC , KC_PGDN,
    //|------------------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+----------------+--------|
    //|----------+----------+----------+------------------------+----------+--------------------+--------+--------+--------+--------+--------|
